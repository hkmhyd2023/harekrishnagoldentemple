...
class ROTPVerificationScreen extends StatefulWidget {
  const ROTPVerificationScreen({Key? key}) : super(key: key);

  @override
  State<ROTPVerificationScreen> createState() => _ROTPVerificationScreenState();
}

class _ROTPVerificationScreenState extends State<ROTPVerificationScreen> {
